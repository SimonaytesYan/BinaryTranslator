...
debug: translation_debug command_system_debug stdlib
	g++ -c Src/main.cpp -o Obj/main.o
	g++ $(DEBUG) -no-pie Obj/main.o Obj/CommandSystem.o Obj/Stdlib.o Obj/Translation.o -o Exe/Translate
release: translation_release command_system_release stdlib
	g++ -c Src/main.cpp -o Obj/main.o
	g++ $(RELEASE) -no-pie Obj/main.o Obj/Stdlib.o Obj/CommandSystem.o Obj/Translation.o -o Exe/Translate
...
stdlib:
	nasm -f elf64 Src/Stdlib.s -o Obj/Stdlib.o
