...
debug: command_system_debug
	g++ $(DEBUG) Src/main.cpp Obj/CommandSystem.o -o Exe/Translate
release: command_system_release
	g++ $(RELEASE) Src/main.cpp Obj/CommandSystem.o -o Exe/Translate
